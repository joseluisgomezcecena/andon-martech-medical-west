            ...
            <div class="box box-danger">
                <form class="form form-inline form-multiline" method="post" role="form">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Filtrado por fechas11</h3>
                    </div>
                    <!-- /.box-header -->
                            ...
                            if(isset($_POST['busqueda_fecha']))
                            {
                                ...
                                if($_SESSION['admin_role'] == 'no')
                                {
                                    ...
                                    else
                                    {
                                     ...
                                     $query3 = "SELECT * FROM (SELECT * FROM martech_fallas WHERE 1 $cell  $inicio $fin $error AND fin != '0000-00-00 00:00:00' UNION ALL SELECT * FROM martech_fallas_backup WHERE 1 $cell  $inicio $fin $error AND fin != '0000-00-00 00:00:00') as l ORDER BY id";
