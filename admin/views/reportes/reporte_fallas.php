...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Incio</a></li>
                ...
                <div class="box-body">
                    <table style="width: 100%;" id="example3" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <th style="font-size:12px;">Fecha de Atención</th>
                        ...
                        <tbody>
                            ...
                            if(isset($_POST['busqueda_fecha']))
                            {
                                ...
                                if($_SESSION['admin_role'] == 'no')
                                {
                                    ...
                                    //SELECT * FROM ( SELECT * FROM martech_fallas UNION ALL SELECT * FROM martech_fallas_backup ) as l ORDER BY id ASC LIMIT 50
                            ...
                            else
                            {
                                ...
                                {
                                    //        SELECT * FROM (SELECT * FROM martech_fallas UNION ALL SELECT * FROM martech_fallas_backup ) as l ORDER BY id
