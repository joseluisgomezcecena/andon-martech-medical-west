                ...
                <div id="mitabla" class="box-body">
                    <table style="width: 100%;"  class="table table-bordered table-striped">
                        ...
                        while($row = mysqli_fetch_array($query))
                        {
                            ...
                            //para mantenimiento
                            if($row['tipo_error'] == "caida" || $row['tipo_error'] == "energia" || $row['tipo_error'] == "agua")
                            {
                                if($row['folio_mantenimiento'] == "")
                                {
                                    $folio = "";
                                }
                                else
                                {
                                    $folio = "Folio: ".$row['folio_mantenimiento'];
                                }
                            }
                            else
                            {
                            ...
                            if($row['tipo_error'] == "setup" )
                            {

                                $parte = "Parte:".$row['parte'];  
                                $orden = "Orden:".$row['orden'];
                            }
                            else
                            {
                                $parte = "";  
