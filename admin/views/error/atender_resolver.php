...
{
    include('includes/martech_atender/atender_error_form.php');
}
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="index.php?page=atender_resolver_list"><i class="fa fa-dashboard"></i> Lista de fallas por resolver</a></li>
            ...
            <div class="box">
                ...
                <br><br/>
                 ...
                 <div class='box-footer'>
                    <a class='btn btn-success' href='index.php?page=error_atender_resolver&id=<?php echo $id ?>&atencion=true'>Resolver</a>       
                    ...
                    ?>
                        ...
                        <a class='btn btn-danger' href='index.php?page=error_atender_resolver&id=<?php echo $id ?>&no_orden=true'>No Se Tiene La Orden</a>       
