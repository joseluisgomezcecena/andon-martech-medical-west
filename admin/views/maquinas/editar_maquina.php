            ...
            <div class="box">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <input type="text" class="form-control" name="centro_trabajo" value="<?php echo $row['centro_trabajo'] ?>">
                        <small>Campo requerido</small>
                    </div>
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <input type="text" class="form-control" name="numero_control" value="<?php echo $row['numero_control'] ?>">
                        <small>Campo requerido</small>
                    </div>
