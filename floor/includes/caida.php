        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div style="background-color: #337ab7; color:#ffffff;" class="modal-header">
              ...
              <h4 class="modal-title">Reporte de <b>Maquina Caida</b></h4>
            </div>
            ...
            <div class="modal-body">
                ...
                <form method="post" onsubmit="myFunction1()">
                    ...
                    <div id="disp">
                        ...
                        <div class="form-group">
                          ...
                          <div id="linea_manual" class="form-group">
                              <label>Captura manual de linea</label><br />
                          ...
                          <div class="form-group">
                              ...
                              <select id="capturado" name="capturado"   class="form-control" required>
                                  <?php 
				 ...
				 <?php 
                                $sql = "SELECT * FROM tecnicos_moldeo";
                                $run_sql = mysqli_query($connection, $sql);
                                while($row_sql = mysqli_fetch_array($run_sql)):
                                ?>
                                    <option >Tecnico: <?php echo $row_sql['user_name']?></option>
                                <?php endwhile; ?>
                          ...
                          <input type="hidden" value="caida" name="tipo_de_error">
