    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div style="background-color: #337ab7; color:#ffffff;" class="modal-header">
                ...
                <h4 class="modal-title">Reporte de <b>Ensamble.</b></h4>
            </div>
                ...
                <form method="post" onsubmit="myFunction1()">
                    ...
                    <div id="disp"><!--desaparece cuando se envia el error --->
                        ...
                        <div class="form-group">
                            ...
                            <select id="second_level_a" name="second_level" multiple class="form-control" required>
                                <option value="">Seleccione</option>
                                <?php
                                $query_assembly = "SELECT * FROM martech_departamentos WHERE planta_id = 2";
                                $result_assembly = mysqli_query($connection, $query_assembly);
                                while($row_assembly = mysqli_fetch_array($result_assembly)):
                                ?>
                                    <option value="<?php echo $row_assembly['id'] ?>"><?php echo $row_assembly['nombre'] ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        ...
                        <div id="maquina" class="form-group">
                            ...
                            <select id="third_level_a" name="third_level"   class="form-control" required>
                        ...
                        <div class="form-group">
                            ...
                            <select style="text-transform: uppercase;" class="form-control" id="descripcion" name="descripcion" required>
                                <option value="">Seleccione</option>
                                <option >Problema en ensamble</option>
                            </select>
                        </div>
                        ...
                        <input type="hidden" value="ensamble" name="tipo_de_error">
