    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div style="background-color: #337ab7; color:#ffffff;" class="modal-header">
              ...
              <h4 class="modal-title">Reporte de <b>Reemplazo de Material</b></h4>
            </div>
                ...
                <form method="post" onsubmit="myFunction1()">
                    ...
                    <div id="disp">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="numero_orden" required>
                        </div>
                    
                    
                        <div class="form-group">
                            <label>Numero de componente</label><br />
                            <input class="form-control" name="numero_componente" required>
                        </div>
                        ...
                        <input type="hidden" value="reemplazo" name="tipo_de_error"><!--tipo de error-->
                    
                        <div class="form-group">
                            <input type="submit" name="submit_error" class="btn btn-primary btn-flat" value="Reportar Error">
                        </div>
                    
                    </div><!--disp desaparece al enviar el error-->
