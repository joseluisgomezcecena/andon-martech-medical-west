...
function escalacion1()
{
    ...
    while($row_fallas = mysqli_fetch_array($run_get_fallas))
    {
        ...
        if($diferencia > 300)//5 minutos 300 segs
        {
            ...
            while($row_responsable = mysqli_fetch_array($responsable_result))
            {
                ...
                try {
                    ...
                    //Recipients
                    $mail->setFrom('andon@martechsender.com', 'Alerta Andon 5 minutos');
            ...
            while($row_supervisores = mysqli_fetch_array($run_supervisores_query))
            {
                ...
                while($row_responsable_s = mysqli_fetch_array($responsable_result_s))
                {
                    ...
                    try {
                        ...
                        //Recipients
                        $mail->setFrom('andon@martechsender.com', 'Alerta Andon 1 hora');
        ...
        if($diferencia > 7500)//3900
        {
            ...
            while($row_responsable = mysqli_fetch_array($responsable_result))
            {
                ...
                try {
                    ...
                    //Recipients
                    $mail->setFrom('andon@martechsender.com', 'Alerta Andon 2 hrs');
        ...
        if($diferencia > 14700)//3900
        {
            ...
            while($row_responsable = mysqli_fetch_array($responsable_result))
            {
                ...
                try {
                    ...
                    //Recipients
                    $mail->setFrom('andon@martechsender.com', 'Alerta Andon 4hrs');
